...
const FrontendDevelopment = ({ onRequestCall }: PageProps) => {
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-14 pb-28">
          <section>
            ...
            <p className="text-lg leading-relaxed text-gray-900 dark:text-gray-200">
              This Frontend Development course teaches you HTML, CSS,
              JavaScript, React, Responsive Design, Tailwind CSS, APIs, and
