...
const BusinessAnalyst = ({ onRequestCall }: PageProps) => {
  ...
  const weeks = [
    ...
    },
    {
      ...
      points: ["Requirement lifecycle", "Live documentation walkthrough"],
    },
    {
      title: "Week 10: Resume & Interview Preparation",
      points: ["Mock interviews", "BA interview questions", "Portfolio setup"],
    },
  ];
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-14 pb-28">
          <section>
            ...
            <p className="text-lg leading-relaxed text-gray-900 dark:text-gray-200">
              ...
              enter the BA field with practical tools, requirement gathering,
