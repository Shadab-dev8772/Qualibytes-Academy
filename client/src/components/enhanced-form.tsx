...
export default function EnhancedForm({ onClose }: FormProps) {
  ...
  return (
    <div className="w-full flex justify-center px-4 sm:px-6">
      ...
      >
        ...
        <p className="text-center text-gray-600 dark:text-gray-300 text-xs sm:text-sm mt-2 mb-6 sm:mb-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
          ...
          <div>
            ...
            >
              <SelectTrigger className="mt-2 h-12 rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white shadow-sm">
          ...
          <div>
            ...
            <Input
              ...
              className="h-12 mt-2 rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white shadow-sm"
            />
          </div>
          ...
          <Button
            disabled={loading}
            type="submit"
            className="w-full h-12 rounded-xl bg-black text-white dark:bg-white dark:text-black"
          >
            {loading ? "Submitting..." : "Book Free Class"}
          </Button>
        </form>

        <p className="text-center text-xs sm:text-sm text-gray-500 dark:text-gray-300 mt-6 sm:mt-8">
